    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', phonenumber_field.modelfields.PhoneNumberField(db_index=True, max_length=128, region=None, verbose_name='Phone Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('hospital_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Hospital.userhospitalrole')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Common.hospitalrole')),
            ],
            options={
                'ordering': ('-created_at',),
                'abstract': False,
